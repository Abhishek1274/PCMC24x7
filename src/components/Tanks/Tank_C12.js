...
const Tank_2 = (props) => {
    ...
    const requestAPI = () => {
        ...
        urlencoded.append("tagids", "907-908-909-910-104-106-105-107");
    ...
    return(
        <>
            ...
            <div className="valvu-status" style={{ top: '110px', left: '733px'}}>
                <div className="valvu-status-title">C12 IN LT-1</div>
            ...
            <div className="valvu-status" style={{ top: '210px', left: '733px'}}>
                <div className="valvu-status-title">C12 D0 S0 CA-1</div>
                <div className="valvu-status-value">
            ...
            <div className="valvu-status" style={{ top: '260px', left: '733px'}}>
                <div className="valvu-status-title">C12 D1 S0 MCMP-1</div>
                <div className="valvu-status-value">
            ...
            <div className="valvu-status" style={{ top: '260px', left: '280px'}}>
                <div className="valvu-status-title">C12 IN MFM-1</div>
                <div className="valvu-status-value">
            ...
            <div className="valvu-status" style={{ top: '360px', left: '280px'}}>
                <div className="valvu-status-title">C12 IN PT-1</div>
                <div className="valvu-status-value">
