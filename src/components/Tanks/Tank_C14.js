...
const Tank_C14 = (props) => {
    ...
    useEffect(() => {
        ...
        ctx.fillText("INLET", 1000, canvasParent.current.clientHeight / 2 + 30);
        ctx.fillStyle = 'black';
        ctx.fill();
        ctx.stroke();
        //pompu line ESR-1
        ...
        //ctx.lineTo(1110, canvasParent.current.clientHeight / 2 + 300);
        ctx.lineTo(1350, canvasParent.current.clientHeight / 2 + 60);
        ctx.lineTo(1350, canvasParent.current.clientHeight / 2 + 300);
        ...
        //ctx.lineTo(1660, canvasParent.current.clientHeight / 2 + 50);

        ctx.lineTo(1360, canvasParent.current.clientHeight / 2 + 300);
        ctx.lineTo(1360, 100);
        ctx.lineTo(1350, 100);
        ctx.strokeStyle = 'black';
        ctx.fillStyle = 'rgba(214,214,214,0.8)';
        ...
        ctx.beginPath();
        ctx.moveTo(1050, canvasParent.current.clientHeight / 2);
        ctx.lineTo(1080, canvasParent.current.clientHeight / 2);
        ctx.lineTo(1080, canvasParent.current.clientHeight / 2 - 5);
        ctx.lineTo(1100, canvasParent.current.clientHeight / 2 + 5);
        ctx.lineTo(1080, canvasParent.current.clientHeight / 2 + 15);
        ctx.lineTo(1080, canvasParent.current.clientHeight / 2 + 10);
        ctx.lineTo(1050, canvasParent.current.clientHeight / 2 + 10);
        ctx.lineTo(1050, canvasParent.current.clientHeight / 2);
        ctx.strokeStyle = 'white';
        ctx.fillStyle = 'blue';
        ...
        output({x: 652, y: canvasParent.current.clientHeight / 2 + 295});
        output({x: 1352, y: canvasParent.current.clientHeight / 2 + 295});
         output({x: 1100, y: canvasParent.current.clientHeight / 2 + 295});
    ...
    return(
        <>
            ...
            <img src={pressureRotateRightLogo} alt="not found" style={{ top: 700, left: 1095 }} width="41" height="30" />
            <img src={pressureRotateLeftLogo} alt="not found" style={{ top: 700, left:623}} width="41" height="30" />
            <img src={ValvuRotateLeftLogo} alt="not found" style={{ top: 600, left: 623 }} width="41" height="30" />
            {/* <img src={pressureRotateRightLogo} alt="not found" style={{ top: 700, left: 1096 }} width="41" height="30" /> */}
            <img src={pressureRotateLeftLogo} alt="not found" style={{ top: 700, left:1325}} width="41" height="30" />
            ...
            <img src={ValvuRotateRightLogo} alt="not found" style={{ top: 600, left: 1100 }} width="41" height="30" />
            {/* <img src={ValvuRotateLeftLogo} alt="not found" style={{ top: 600, left: 1100 }} width="41" height="30" /> */}
            <img src={ValvuRotateLeftLogo} alt="not found" style={{ top: 600, left: 1325 }} width="41" height="30" />
            ...
            <div className="valvu-status" style={{ top: '700px', left: '440px'}}>
                <div className="valvu-status-title">MFM_B1_D2_S0_MFM_2_DN300</div>
                <div className="valvu-status-value">
                    <span>{ exponentailHandle({...(Object.assign({}, { ...tags[6] }.children))[2]}.value) }</span>
                    <span>m3/hr</span>
                </div>
            ...
            <div className="valvu-status" style={{ top: '700px', left: '900px'}}>
                <div className="valvu-status-title">MFM_A1_D3_S0_DN300</div>
                <div className="valvu-status-value">
                    <span>{ exponentailHandle({...(Object.assign({}, { ...tags[6] }.children))[2]}.value) }</span>
                    <span>m3/hr</span>
                </div>
            ...
            <div className="valvu-status" style={{ top: '700px', left: '1440px'}}>
                <div className="valvu-status-title">MFM_A1_D3_S0_MFM_2_DN300</div>
                <div className="valvu-status-value">
                    <span>{ exponentailHandle({...(Object.assign({}, { ...tags[6] }.children))[2]}.value) }</span>
                    <span>m3/hr</span>
            ...
            <div className="valvu-name" style={{ top: height / 2 + 150 + "px", left: "550px" }}>
                A1 D3 S0 ASV-1 DN300
            </div>
            <div className="valvu-name" style={{ top: height / 2 + 150 + "px", left: "1250px" }}>
                A1 D3 S0 ASV-2 DN300
            </div>
            {/* <button style={{top: height / 2 + 350 + "px", left: "325px"}}>DMA-1</button>
            <button style={{top: height / 2 + 350 + "px", left: "585px"}}>DMA-2</button>
            <button style={{top: height / 2 + 350 + "px", left: "840px"}}>DMA-3</button>
            <button style={{top: height / 2 + 350 + "px", left: "1280px"}}>DMA-1</button> */}
        </>
    )
}

export default Tank_C14;