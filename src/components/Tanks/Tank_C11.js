...
const Tank_C11 = (props) => {
    ...
    const requestAPI = () => {
        ...
        urlencoded.append("tagids", "903-904-905-906-97-101-247-98-102-248-99-103-249-96-100");
    ...
    return(
        <>
            ...
            <div className="valvu-status" style={{ top: '110px', left: '733px'}}>
                <div className="valvu-status-title">C11 IN LT-1</div>
            ...
            <div className="valvu-status" style={{ top: '210px', left: '733px'}}>
                <div className="valvu-status-title">C11 D0 S0 CA-1</div>
                <div className="valvu-status-value">
            ...
            <div className="valvu-status" style={{ top: '260px', left: '733px'}}>
                <div className="valvu-status-title">C11 D1 S0 MCMP-1</div>
                <div className="valvu-status-value">
            ...
            <div className="valvu-status" style={{ top: '700px', left: '1146px'}}>
                <div className="valvu-status-title">C11 D3 SO_MFM-3 DN300</div>
                <div className="valvu-status-value">
            ...
            <div className="valvu-status" style={{ top: '700px', left: '766px'}}>
                <div className="valvu-status-title">C11 D2 SO_MFM-2 DN300</div>
                <div className="valvu-status-value">
            ...
            <div className="valvu-status" style={{ top: '260px', left: '280px'}}>
                <div className="valvu-status-title">C11 IN MFM-1</div>
                <div className="valvu-status-value">
            ...
            <div className="valvu-status" style={{ top: '360px', left: '280px'}}>
                <div className="valvu-status-title">C11 IN PT-1</div>
                <div className="valvu-status-value">
            ...
            <div className="valvu-status" style={{ top: '700px', left: '250px'}}>
                <div className="valvu-status-title">C11 D1 S0_MFM-1 DN300</div>
                <div className="valvu-status-value">
