...
const Tank_B1 = (props) => {
    ...
    useEffect(() => {
        ...
        ctx.lineTo(410, canvasParent.current.clientHeight / 2 + 60);
         ...
         ctx.lineTo(660, canvasParent.current.clientHeight / 2 + 300);
         ctx.lineTo(660, canvasParent.current.clientHeight / 2 + 60);
       ...
       // ctx.lineTo(1100, canvasParent.current.clientHeight / 2 + 50);
        ...
        // output({x: 1502, y: canvasParent.current.clientHeight / 2 + 295});
    ...
    return(
        <>
            ...
            <div className="valvu-status" style={{ top: '700px', left: '680px'}}>
            ...
            <button style={{top: height / 2 + 350 + "px", left: "325px"}} onClick={handleClick}>DMA-1</button>
            <button style={{top: height / 2 + 350 + "px", left: "585px"}} onClick={handleClick}>DMA-2</button>
            <button style={{top: height / 2 + 350 + "px", left: "840px"}} onClick={handleClick}>DMA-3</button>
            <button style={{top: height / 2 + 350 + "px", left: "1280px"}} onClick={handleClick}>DMA-1</button>
        </>
    )
}

export default Tank_B1;