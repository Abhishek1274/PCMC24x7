...
const Tank_B1G = (props) => {
    ...
    return(
        <>
            ...
            <img src={pressureRotateRightLogo} alt="not found" style={{ top: 440, left: 645 }} width="41" height="30" />
            ...
            <img src={ValvuRotateRightLogo} alt="not found" style={{ top: 350, left: 645 }} width="41" height="30" />
            ...
            <div className="valvu-status" style={{ top: '210px', left: '733px'}}>
                ...
                <div className="valvu-status-value">
                    <span>{ exponentailHandle({...(Object.assign({}, { ...tags[7] }.children))[2]}.value) }</span>
                    <span>ppm</span>
                </div>
            </div>
            <div className="valvu-status" style={{ top: '260px', left: '733px'}}>
                ...
                <div className="valvu-status-value">
                    <span>{ exponentailHandle({...(Object.assign({}, { ...tags[8] }.children))[2]}.value) }</span>
                    <span>bar</span>
                </div>
            </div>
            <div className="valvu-status" style={{ top: '430px', left: '733px'}}>
                <div className="valvu-status-title">MFM_A2_D3_S0_MFM_2_DN300</div>
                <div className="valvu-status-value">
                    <span>{ exponentailHandle({...(Object.assign({}, { ...tags[9] }.children))[2]}.value) }</span>
                    <span>m3/hr</span>
                </div>
                <div className="valvu-status-value">
                    <span>{ exponentailHandle({...(Object.assign({}, { ...tags[10] }.children))[2]}.value) }</span>
                    <span>m3</span>
                    <span>Today</span>
                </div>
                <div className="valvu-status-value">
                    <span>{ exponentailHandle({...(Object.assign({}, { ...tags[11] }.children))[2]}.value) }</span>
                    <span>m3</span>
                    <span>Prev.day</span>
                </div>
            </div>
            <div className="valvu-status" style={{ top: '260px', left: '280px'}}>
                ...
                <div className="valvu-status-value">
                    <span>{ exponentailHandle({...(Object.assign({}, { ...tags[0] }.children))[2]}.value) }</span>
                    <span>m3/hr</span>
                </div>
                <div className="valvu-status-value">
                    <span>{ exponentailHandle({...(Object.assign({}, { ...tags[1] }.children))[1]}.value) }</span>
                    <span>bar</span>
                </div>
            </div>
            <div className="valvu-status" style={{ top: '360px', left: '280px'}}>
                ...
                <div className="valvu-status-value">
                    <span>{ exponentailHandle({...(Object.assign({}, { ...tags[2] }.children))[2]}.value) }</span>
                    <span>bar</span>
                </div>
            </div>
                {/* <div className="valvu-status" style={{ top: '700px', left: '250px'}}>
                    <div className="valvu-status-title">MFM_A2_D3_S0_MFM_2_DN300</div>
                    <div className="valvu-status-value">
                        <span>{ exponentailHandle({...(Object.assign({}, { ...tags[3] }.children))[2]}.value) }</span>
                        <span>m3/hr</span>
                    </div>
                    <div className="valvu-status-value">
                        <span>{ exponentailHandle({...(Object.assign({}, { ...tags[4] }.children))[2]}.value) }</span>
                        <span>m3</span>
                        <span>Today</span>
                    </div>
                    <div className="valvu-status-value">
                        <span>{ exponentailHandle({...(Object.assign({}, { ...tags[5] }.children))[2]}.value) }</span>
                        <span>m3</span>
                        <span>Prev.day</span>
                    </div>
                </div> */}

            <div className="valvu-name" style={{ top: 385 + "px", left: "650px" }}>
